...
| 06 | Complete | `feat/api-06-shops` | `75d388e` | Shop API commit, documentation commit | 50 tests; syntax check; build; database lint; live disposable create, update, public read, pickup replacement, logo upload, cleanup | One shop per seller, stable slug, atomic pickup areas, and public logo/banner storage |
