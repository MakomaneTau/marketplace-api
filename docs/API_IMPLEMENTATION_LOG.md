...
| 13 | Complete | `feat/api-13-settings-hardening` | `4a05f0e` | implementation and documentation pending commit | 82 tests; syntax check; build; database lint; live disposable preference defaults/update/cleanup | Persisted notification settings, multi-origin CORS, opt-in proxy trust, HSTS, and browser capability headers |
