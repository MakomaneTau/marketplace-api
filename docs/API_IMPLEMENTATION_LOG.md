...
| 14 | Complete | `test/api-14-acceptance` | `279173d` | `4537bd5`, `d474386`; merge `81f285d` | 82 tests; 63-file syntax/build; database lint; all live smokes; cleanup verified | Repeatable non-destructive acceptance command and API readiness report |
