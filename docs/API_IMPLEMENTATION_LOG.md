...
| 07 | Complete | `feat/api-07-products-catalog` | `99fbe1d` | `3379773`, `22c4aa5`; merge pending | 55 tests; syntax check; build; database lint; live disposable seller draft, managed image upload, activation, public filters, seller inventory, cleanup | Paginated discovery, complete seller inventory routes, and six-image lifecycle |
